(function() {
  ...
  function drawFilter() {
    ...
    ctx.drawImage(
      preview,
      currentX - preview.width / 2,
      currentY - preview.height / 2,
      preview_width,
      preview_height
    );
  }
  ...
  upload_file_button.addEventListener(
    "click",
    function(ev) {
      upload_file.click();
    },
